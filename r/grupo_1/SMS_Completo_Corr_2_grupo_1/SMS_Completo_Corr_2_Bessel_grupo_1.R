...
sink("my_output_SMS_Rank_Corr_2.txt")
...
write.csv(rank_RF_df, "rank_Random_Forest_2.txt", row.names = TRUE)

write.csv(as.data.frame(rank_global_selec[[i]]),"rank_global_2.txt", row.names = TRUE )

#write this string to file
#define file name
sink("my_output_SMS_Bessel_Corr_2.txt")
...
save.image(file="SMS_corr_2.RData")
